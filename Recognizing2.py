...
class Ui_Recognizing2(object):
    def setupUi(self, Recognizing2):
        ...
        self.recommendback.setStyleSheet("border-image: url(./pyqtpic/back.png);")
        self.recommendback.setText("")
        self.recommendback.setObjectName("recommendbackground")
        self.name = QtWidgets.QLabel(Recognizing2)
        self.name.setGeometry(QtCore.QRect(640, 35, 131, 41))
        self.name.setStyleSheet("background-color: rgb(255, 255,255, 0);\n"
                                "font: 20pt \"Arial Rounded MT Bold\";""color:white;""")
        self.name.setText("")
        self.name.setAlignment(QtCore.Qt.AlignCenter)
        self.name.setObjectName("name")
        self.iLike = QtWidgets.QPushButton(Recognizing2)
        self.iLike.setGeometry(QtCore.QRect(635, 100, 35, 36))
        self.iLike.setStyleSheet("QPushButton\n"
                                 "{\n"
                                 "    border-image: url(./pyqtpic/like.png);\n"
                                 "    color:transparnt;\n"
                                 "}\n")
        ...
        self.origin.setGeometry(QtCore.QRect(557, 35, 61, 51))
